...
# Paddle public (NEXT_PUBLIC_*) build args — inlined by Next.js during `pnpm build`
...
ARG NEXT_PUBLIC_PADDLE_MANAGE_URL
ENV NEXT_PUBLIC_PADDLE_MANAGE_URL=$NEXT_PUBLIC_PADDLE_MANAGE_URL

# Polar public (NEXT_PUBLIC_*) build args
