...
- Icon size: use `size-4` for all icons. Use `size-8` for square icon buttons (`size='icon'`). Exception: the AppMode rail (`src/components/ui/tool-sidebar.tsx`, `src/components/projects/project-switcher.tsx`) stays at `size-10`
