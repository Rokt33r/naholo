...
Once it is installed, verify your setup with the following skill.

```
/naholo-doctor
```

`/naholo-doctor` checks your CLI version, login, and project setup, and tells you how to fix anything that is off.
