...
> After installing, if the skill does not show up in the VS Code Claude plugin, run `/reload-skills` or reload the window (press Cmd+P, then select `Developer: Reload Window`).
