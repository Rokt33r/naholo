...
/**
 * GET /api/projects/[projectSlug]/skill-sets/[skillSetSlug]
...
export async function GET(_request: NextRequest, context: RouteContext) {
  try {
    ...
    const skillSet = await getSkillSet(project.id, decodedSlug)
    if (skillSet == null) {
...
/**
 * PATCH /api/projects/[projectSlug]/skill-sets/[skillSetSlug]
 * Update a skill set
 */
...
/**
 * DELETE /api/projects/[projectSlug]/skill-sets/[skillSetSlug]
