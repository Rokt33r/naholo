...
> 2. Install the plugin in Claude Code: run `/plugin marketplace add rokt33r/naholo-claude-plugin`, then `/plugin install naholo-claude-plugin@naholo`, then reload with `/reload-plugins`.
